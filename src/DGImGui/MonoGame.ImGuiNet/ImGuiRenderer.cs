...
namespace MonoGame.ImGuiNet
{
    ...
    public class ImGuiRenderer
    {
        ...
        /// </summary>
        protected virtual Microsoft.Xna.Framework.Graphics.Effect UpdateEffect(Texture2D texture)
        {
        ...
        protected virtual void UpdateInput()
        {
            ...
            io.AddMouseButtonEvent(0, mouse.RightButton == ButtonState.Pressed);
            io.AddMouseButtonEvent(1, mouse.LeftButton == ButtonState.Pressed);
        ...
        private bool TryMapKeys(Keys key, out ImGuiKey imguikey)
        {
            ...
            switch (key)
            {
                ...
                case Keys.Delete:
                    ...
                    break;
                case var _ when key >= Keys.D0 && key <= Keys.D9:
                    imguikey = ImGuiKey._0 + (key - Keys.D0);
                    break;
                case var _ when key >= Keys.A && key <= Keys.Z:
                    imguikey = ImGuiKey.A + (key - Keys.A);
                    break;
                case var _ when key >= Keys.NumPad0 && key <= Keys.NumPad9:
                    imguikey = ImGuiKey.Keypad0 + (key - Keys.NumPad0);
                    break;
                case Keys.Multiply:
                ...
                case Keys.Divide:
                    ...
                    break;
                case var _ when key >= Keys.F1 && key <= Keys.F12:
                    imguikey = ImGuiKey.F1 + (key - Keys.F1);
                    break;
                case Keys.NumLock:
                ...
                case Keys.Scroll:
                    ...
                    break;
                case Keys.LeftShift:
                    imguikey = ImGuiKey.ModShift;
                    break;
                case Keys.LeftControl:
                    imguikey = ImGuiKey.ModCtrl;
                    break;
                case Keys.LeftAlt:
                    imguikey = ImGuiKey.ModAlt;
                    break;
        ...
        private unsafe void UpdateBuffers(ImDrawDataPtr drawData)
        {
            ...
            for (int n = 0; n < drawData.CmdListsCount; n++)
            {
                ...
                {
                    // MIGHT CRASH
                    byte[] vtxArray = Util.PointerToByteArray(cmdList.VtxBuffer.Data, cmdList.VtxBuffer.Size * DrawVertDeclaration.Size);
                    byte[] bfrArray = Util.PointerToByteArray(cmdList.IdxBuffer.Data, cmdList.IdxBuffer.Size * sizeof(ushort));
                    Marshal.Copy(vtxArray, 0, new IntPtr(vtxDstPtr), vtxArray.Length);
                    Marshal.Copy(bfrArray, 0, new IntPtr(idxDstPtr), bfrArray.Length);
                }
